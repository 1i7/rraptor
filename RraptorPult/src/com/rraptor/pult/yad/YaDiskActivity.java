...
public class YaDiskActivity extends FragmentActivity {
	...
	public static class AuthDialogFragment extends DialogFragment {
		...
		public Dialog onCreateDialog(Bundle savedInstanceState) {
			return new AlertDialog.Builder(getActivity())
					...
					.setPositiveButton(R.string.example_auth_positive_button,
					...
					.setNegativeButton(R.string.example_auth_negative_button,
							new DialogInterface.OnClickListener() {
								@Override
								public void onClick(DialogInterface dialog,
										int which) {
	...
	private class GetAuthTokenCallback implements
		...
		public void run(AccountManagerFuture<Bundle> result) {
			try {
				...
				String message = (String) bundle
						.get(AccountManager.KEY_ERROR_MESSAGE);
				if (message != null) {
					Toast.makeText(YaDiskActivity.this, message,
				...
				Toast.makeText(YaDiskActivity.this, ex.getMessage(),
						Toast.LENGTH_LONG).show();
	...
	public static String KEY_DOWNLOADED_FILE_PATH = "FILE";
	...
	// create your own client id/secret pair with callback url on
	// oauth.yandex.ru
	...
	private void getAuthToken(Account account) {
		...
		systemAccountManager.getAuthToken(account, CLIENT_ID, options, this,
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == GET_ACCOUNT_CREDS_INTENT) {
			if (resultCode == RESULT_OK) {
				...
				Log.d(TAG, "GET_ACCOUNT_CREDS_INTENT: name=" + name + " type="
						+ type);
	...
	public void reloadContent() {
		ListExampleFragment fragment = (ListExampleFragment) getSupportFragmentManager()
	...
	private void startFragment() {
		getSupportFragmentManager()
				.beginTransaction()
				.replace(android.R.id.content, new ListExampleFragment(),
						FRAGMENT_TAG).commit();
	};
}
